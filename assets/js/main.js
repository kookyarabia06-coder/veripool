...
// ========================================
// VERIPOOL RESORT - CLEAN INTERACTIONS
...
// Image lazy loading with subtle fade
document.querySelectorAll('.room-image img, .cottage-image img').forEach(img => {
    img.style.opacity = '0';
